    ...
    return (
      <div id="wrapper">
        <div id="app">
          ...
          {this.state.items.length > 0 && (
            <div id="clear-items" onClick={this.clearItems}>
              Clear items
            </div>
          )}
        </div>
    ...
    return (
      <div className={this.props.item.checked ? "item-checked" : "item"}>
        <input
          type="text"
          className={
            this.props.item.checked ? "item-text-checked" : "item-text"
          }
          ...
          onChange={(event) => {
            ...
            this.props.updateItem(
              event.target.value,
              this.props.itemList.indexOf(this.props.item)
            );
          }}
        />

        <div
          className="delete-button item-icon"
          onClick={() => {
        ...
        <div
          className="check-button item-icon"
          onClick={() => {
            // submit item index to function
